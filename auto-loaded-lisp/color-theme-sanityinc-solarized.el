    ...
    (let ((background (first backgrounds))
      ...
      (color-theme-install
       `(,(intern (concat "color-theme-sanityinc-solarized-" (symbol-name'light)))
         ...
         (flyspell-duplicate-face ((t (:inherit flymake-errline))))
         (flyspell-incorrect-face ((t (:inherit flymake-errline))))
         ...
         ;; Search
         (match ((t (:foreground ,strong :background nil :inverse-video t))))
         ...
         ;; idle-highlight
         (idle-highlight  ((t (:foreground ,strong :background nil :inverse-video t))))

         ;; yasnippets currently active field
         (yas/field-highlight-face ((t (:foreground ,strong :background nil :inverse-video t))))
